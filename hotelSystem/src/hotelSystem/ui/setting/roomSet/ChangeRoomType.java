...
public class ChangeRoomType extends JFrame {
	...
	public ChangeRoomType() {
...

		{
			...
			JLabel label_4 = new JLabel("预设押金");
			label_4.setBounds(68, 276, 108, 29);
			getContentPane().add(label_4);

			JLabel label_5 = new JLabel("钟点计费");
			...
			button_enter.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					// 保存修改后的房间类型
					logic.setRoomType(ChangeRoomType.this);
				}
			});
			button_enter.setBounds(68, 475, 153, 37);
			...
			text_type_id.setEditable(false);
		...
		// 获得所有房间类型
		logic.getRoomType(ChangeRoomType.this);
	}
}
